...
sub TRANSCRIPT {
	...
	$dbh = $_[0]; 
	$t = Text::TabularDisplay->new(qw(SampleID	Organism Tissue TotalReads MappedReads	AlignmentRate Genes(total) Isoforms(total) Variants(total) SNVs(total) InDELs(total))); #header
