...
my $dbh = mysql($all_details{"MySQL-databasename"}, $all_details{'MySQL-username'}, $all_details{'MySQL-password'}); #connect to mysql
...
$verbose and printerr ("Success: Import to \"".$all_details{"MySQl-databasename"}."\"\n");
$verbose and printerr ("Success: Creation of FastBit folder \"".$all_details{"FastBit-foldername"}."\"\n");
