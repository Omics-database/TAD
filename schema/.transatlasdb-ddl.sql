...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Sample` (`sampleid` VARCHAR(50) NOT NULL,`tissue` VARCHAR(100) NULL DEFAULT NULL,`derivedfrom` VARCHAR(100) NULL DEFAULT NULL,`organism` VARCHAR(100) NOT NULL,`collectiondate` DATE NULL DEFAULT NULL,`scientist` TEXT NULL DEFAULT NULL,`organizationname` TEXT NULL DEFAULT NULL, `sampleinfo` TEXT NULL DEFAULT NULL,PRIMARY KEY (`sampleid`, `organism`), INDEX `sample_indx_organism` (`organism` ASC)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `MapStats`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `MapStats` (`sampleid` VARCHAR(50) NOT NULL, `totalreads` INT(11) NULL DEFAULT NULL, `mappedreads` INT(11) NULL DEFAULT NULL, `unmappedreads` INT(11) NULL DEFAULT NULL, `deletions` INT(11) NULL DEFAULT NULL, `insertions` INT(11) NULL DEFAULT NULL, `junctions` INT(11) NULL DEFAULT NULL, `isoforms` INT(11) NULL DEFAULT NULL, `genes` INT(11) NULL DEFAULT NULL, `infoprepreads` TEXT NULL DEFAULT NULL, `date` DATE NULL DEFAULT NULL, `status` CHAR(10) NULL, PRIMARY KEY (`sampleid`), CONSTRAINT `MapStats_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `Sample` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `Metadata`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Metadata` ( `sampleid` VARCHAR(50) NOT NULL, `refgenome` VARCHAR(50) NULL DEFAULT NULL, `annfile` VARCHAR(20) NULL DEFAULT NULL, `annfilever` VARCHAR(50) NULL DEFAULT NULL, `stranded` VARCHAR(50) NULL DEFAULT NULL, `sequencename` TEXT NULL DEFAULT NULL, CONSTRAINT `metadata_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `MapStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `GenesFpkm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `GenesFpkm` (`sampleid` VARCHAR(50) NOT NULL, `trackingid` VARCHAR(50) NOT NULL DEFAULT '', `classcode` VARCHAR(20) NULL DEFAULT NULL, `nearestrefid` VARCHAR(20) NULL DEFAULT NULL, `geneid` VARCHAR(50) NOT NULL DEFAULT '', `geneshortname` VARCHAR(200) NOT NULL DEFAULT '', `tssid` VARCHAR(50) NOT NULL DEFAULT '', `chromnumber` VARCHAR(50) NOT NULL DEFAULT '', `chromstart` INT(11) NOT NULL DEFAULT '0', `chromstop` INT(11) NOT NULL DEFAULT '0', `length` INT(11) NULL DEFAULT NULL, `coverage` DOUBLE(20,10) NULL DEFAULT NULL, `fpkm` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconflow` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconfhigh` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmstatus` VARCHAR(10) NULL DEFAULT NULL, INDEX `genesfpkm_indx_geneshortname` (`geneshortname` ASC), INDEX `genesfpkm_ibfk_1_idx` (`sampleid` ASC), PRIMARY KEY (`sampleid`), CONSTRAINT `genesfpkm_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `Sample` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `IsoformsFpkm`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `IsoformsFpkm` ( `sampleid` VARCHAR(50) NOT NULL, `trackingid` VARCHAR(50) NOT NULL DEFAULT '', `classcode` VARCHAR(20) NULL DEFAULT NULL, `nearestrefid` VARCHAR(20) NULL DEFAULT NULL, `geneid` VARCHAR(50) NOT NULL DEFAULT '', `geneshortname` VARCHAR(20) NOT NULL DEFAULT '', `tssid` VARCHAR(50) NOT NULL DEFAULT '', `chromnumber` VARCHAR(50) NOT NULL DEFAULT '', `chromstart` INT(11) NOT NULL DEFAULT '0', `chromstop` INT(11) NOT NULL DEFAULT '0', `length` INT(11) NULL DEFAULT NULL, `coverage` DOUBLE(20,10) NULL DEFAULT NULL, `fpkm` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconflow` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconfhigh` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmstatus` VARCHAR(10) NULL DEFAULT NULL, INDEX `isoformsfpkm_indx_geneshortname` (`geneshortname` ASC), INDEX `isoformsfpkm_ibfk_1_idx` (`sampleid` ASC), PRIMARY KEY (`sampleid`), CONSTRAINT `isoformsfpkm_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `Sample` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `VarSummary`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `VarSummary` (`sampleid` VARCHAR(50) NOT NULL, `totalvariants` INT(11) NULL DEFAULT NULL, `totalsnps` INT(11) NULL DEFAULT NULL, `totalindels` INT(11) NULL DEFAULT NULL, `annversion` VARCHAR(50) NULL DEFAULT NULL, `varianttool` VARCHAR(50) NULL DEFAULT NULL, `toolversion` VARCHAR(50) NULL DEFAULT NULL, `date` DATE NOT NULL, `status` CHAR(10) NULL DEFAULT NULL, `nosql` CHAR(10) NULL DEFAULT NULL, PRIMARY KEY (`sampleid`), CONSTRAINT `varsummary_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `MapStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
-- View `vw_libraryinfo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vw_libraryinfo` (`sampleid` INT, `organism` INT, `tissue` INT, `sampleinfo` INT, `mappedreads` INT, `genes` INT, `isoforms` INT, `totalvariants` INT, `totalsnps` INT, `totalindels` INT);
DROP VIEW IF EXISTS `vw_libraryinfo` ;
DROP TABLE IF EXISTS `vw_libraryinfo`;
CREATE VIEW `vw_libraryinfo` AS select `a`.`sampleid` AS `sampleid`, `a`.`organism` AS `organism`,`a`.`tissue` AS `tissue`,`a`.`sampleinfo` AS `sampleinfo`,`b`.`mappedreads` AS `mappedreads`,`b`.`genes` AS `genes`,`b`.`isoforms` AS `isoforms`,`c`.`totalvariants` AS `totalvariants`,`c`.`totalsnps` AS `totalsnps`,`c`.`totalindels` AS `totalindels` from ((`Sample` `a` join `MapStats` `b` on((`a`.`sampleid` = `b`.`sampleid`))) join `VarSummary` `c` on((`a`.`sampleid` = `c`.`sampleid`)));
-- -----------------------------------------------------
-- View `vw_variants`
-- -----------------------------------------------------
