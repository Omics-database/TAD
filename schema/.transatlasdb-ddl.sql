...
CREATE TABLE `Sample` (`sampleid` VARCHAR(50) NOT NULL,`tissue` VARCHAR(100) NULL DEFAULT NULL,`derivedfrom` VARCHAR(100) NULL DEFAULT NULL,`organism` VARCHAR(100) NOT NULL,`collectiondate` DATE NULL DEFAULT NULL,`scientist` TEXT NULL DEFAULT NULL,`organizationname` TEXT NULL DEFAULT NULL, `sampleinfo` TEXT NULL DEFAULT NULL,PRIMARY KEY (`sampleid`, `organism`), INDEX `sample_indx_organism` (`organism` ASC)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `MapStats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MapStats`;
CREATE TABLE `MapStats` (`sampleid` VARCHAR(50) NOT NULL, `totalreads` INT(11) NULL DEFAULT NULL, `mappedreads` INT(11) NULL DEFAULT NULL, `unmappedreads` INT(11) NULL DEFAULT NULL, `infoprepreads` TEXT NULL DEFAULT NULL, `date` DATE NULL DEFAULT NULL, PRIMARY KEY (`sampleid`), CONSTRAINT `MapStats_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `Sample` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `GeneStats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GeneStats`;
CREATE TABLE `GeneStats` (`sampleid` VARCHAR(50) NOT NULL, `deletions` INT(11) NULL DEFAULT NULL, `insertions` INT(11) NULL DEFAULT NULL, `junctions` INT(11) NULL DEFAULT NULL, `isoforms` INT(11) NULL DEFAULT NULL, `genes` INT(11) NULL DEFAULT NULL, `date` DATE NULL DEFAULT NULL, `status` CHAR(10) NULL,PRIMARY KEY (`sampleid`), CONSTRAINT `GeneStats_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `MapStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `Metadata`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Metadata`;
CREATE TABLE `Metadata` ( `sampleid` VARCHAR(50) NOT NULL, `refgenome` VARCHAR(50) NULL DEFAULT NULL, `annfile` VARCHAR(20) NULL DEFAULT NULL, `stranded` VARCHAR(50) NULL DEFAULT NULL, `sequencename` TEXT NULL DEFAULT NULL, CONSTRAINT `metadata_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `MapStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `GenesFpkm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `GenesFpkm`;
CREATE TABLE `GenesFpkm` (`sampleid` VARCHAR(50) NOT NULL, `trackingid` VARCHAR(50) NOT NULL DEFAULT '', `classcode` VARCHAR(20) NULL DEFAULT NULL, `nearestrefid` VARCHAR(20) NULL DEFAULT NULL, `geneid` VARCHAR(50) NOT NULL DEFAULT '', `geneshortname` VARCHAR(200) NOT NULL DEFAULT '', `tssid` VARCHAR(50) NOT NULL DEFAULT '', `chromnumber` VARCHAR(50) NOT NULL DEFAULT '', `chromstart` INT(11) NOT NULL DEFAULT '0', `chromstop` INT(11) NOT NULL DEFAULT '0', `length` INT(11) NULL DEFAULT NULL, `coverage` DOUBLE(20,10) NULL DEFAULT NULL, `fpkm` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconflow` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconfhigh` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmstatus` VARCHAR(10) NULL DEFAULT NULL, INDEX `genesfpkm_indx_geneshortname` (`geneshortname` ASC), INDEX `genesfpkm_ibfk_1_idx` (`sampleid` ASC), PRIMARY KEY (`sampleid`, `trackingid`, `geneid`, `geneshortname`, `tssid`, `chromnumber`,`chromstart`,`chromstop`,`fpkm`,`fpkmconflow`,`fpkmconfhigh`), KEY `genesfpkm_indx_geneshortname_1` (`geneshortname`), CONSTRAINT `genesfpkm_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `GeneStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `IsoformsFpkm`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `IsoformsFpkm`;
CREATE TABLE `IsoformsFpkm` ( `sampleid` VARCHAR(50) NOT NULL, `trackingid` VARCHAR(50) NOT NULL DEFAULT '', `classcode` VARCHAR(20) NULL DEFAULT NULL, `nearestrefid` VARCHAR(20) NULL DEFAULT NULL, `geneid` VARCHAR(50) NOT NULL DEFAULT '', `geneshortname` VARCHAR(20) NOT NULL DEFAULT '', `tssid` VARCHAR(50) NOT NULL DEFAULT '', `chromnumber` VARCHAR(50) NOT NULL DEFAULT '', `chromstart` INT(11) NOT NULL DEFAULT '0', `chromstop` INT(11) NOT NULL DEFAULT '0', `length` INT(11) NULL DEFAULT NULL, `coverage` DOUBLE(20,10) NULL DEFAULT NULL, `fpkm` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconflow` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmconfhigh` DOUBLE(20,5) NOT NULL DEFAULT '0.00000', `fpkmstatus` VARCHAR(10) NULL DEFAULT NULL, INDEX `isoformsfpkm_indx_geneshortname` (`geneshortname` ASC), INDEX `isoformsfpkm_ibfk_1_idx` (`sampleid` ASC), PRIMARY KEY (`sampleid`, `trackingid`, `geneid`, `geneshortname`, `tssid`, `chromnumber`,`chromstart`,`chromstop`,`fpkm`,`fpkmconflow`,`fpkmconfhigh`), KEY `isoformsfpkm_indx_geneshortname_1` (`geneshortname`), CONSTRAINT `isoformsfpkm_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `GeneStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `VarSummary`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `VarSummary`;
CREATE TABLE `VarSummary` (`sampleid` VARCHAR(50) NOT NULL, `totalvariants` INT(11) NULL DEFAULT NULL, `totalsnps` INT(11) NULL DEFAULT NULL, `totalindels` INT(11) NULL DEFAULT NULL, `annversion` VARCHAR(50) NULL DEFAULT NULL, `varianttool` VARCHAR(50) NULL DEFAULT NULL, `date` DATE NOT NULL, `status` CHAR(10) NULL DEFAULT NULL, `nosql` CHAR(10) NULL DEFAULT NULL, PRIMARY KEY (`sampleid`), CONSTRAINT `varsummary_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `MapStats` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `VarResult`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `VarResult`;
CREATE TABLE `VarResult` ( `sampleid` VARCHAR(50) NOT NULL, `chrom` VARCHAR(50) NOT NULL DEFAULT '', `position` INT(11) NOT NULL DEFAULT '0', `refallele` VARCHAR(50) NULL DEFAULT NULL, `altallele` VARCHAR(50) NULL DEFAULT NULL, `quality` DOUBLE(20,5) NULL DEFAULT NULL, `variantclass` VARCHAR(50) NULL DEFAULT NULL, `zygosity` VARCHAR(50) NULL DEFAULT NULL, `dbsnpvariant` VARCHAR(50) NULL DEFAULT NULL, PRIMARY KEY (`sampleid`, `chrom`, `position`), CONSTRAINT `varresult_ibfk_1` FOREIGN KEY (`sampleid`) REFERENCES `VarSummary` (`sampleid`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
-- Table structure for table `VarAnno`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `VarAnno`;
CREATE TABLE `VarAnno` (`sampleid` VARCHAR(50) NOT NULL, `chrom` VARCHAR(50) NOT NULL DEFAULT '', `position` INT(11) NOT NULL DEFAULT '0', `consequence` VARCHAR(50) NOT NULL DEFAULT '', `source` VARCHAR(50) NULL DEFAULT NULL, `geneid` VARCHAR(50) NOT NULL DEFAULT '', `genename` VARCHAR(50) NULL DEFAULT NULL, `transcript` VARCHAR(200) NULL DEFAULT NULL, `feature` VARCHAR(50) NULL DEFAULT NULL, `genetype` VARCHAR(200) NULL DEFAULT NULL, `proteinposition` VARCHAR(50) NOT NULL DEFAULT '', `aachange` VARCHAR(50) NULL DEFAULT NULL, `codonchange` VARCHAR(50) NULL DEFAULT NULL, PRIMARY KEY (`consequence`, `geneid`, `proteinposition`, `sampleid`, `chrom`, `position`), INDEX `varanno_indx_genename` (`genename` ASC), CONSTRAINT `varanno_ibfk_1` FOREIGN KEY (`sampleid` , `chrom` , `position`) REFERENCES `VarResult` (`sampleid` , `chrom` , `position`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
-- -----------------------------------------------------
...
CREATE TABLE `vw_annotation` (`sampleid` INT, `chrom` INT, `position` INT, `refallele` INT, `altallele` INT, `annotation` INT, `amount` INT);
DROP VIEW IF EXISTS `vw_annotation` ;
DROP TABLE IF EXISTS `vw_annotation`;
...
CREATE TABLE `vw_libraryinfo` (`sampleid` INT, `organism` INT, `tissue` INT, `sampleinfo` INT, `mappedreads` INT, `genes` INT, `isoforms` INT, `totalvariants` INT, `totalsnps` INT, `totalindels` INT);
DROP VIEW IF EXISTS `vw_libraryinfo` ;
DROP TABLE IF EXISTS `vw_libraryinfo`;
